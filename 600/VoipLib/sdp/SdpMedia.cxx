/*
 * $Id: SdpMedia.cxx,v 1.3 2007/06/05 11:33:25 lizhijie Exp $
 */
...
SdpMedia::SdpMedia (split_t& mediaDetails)
{
    ...
    while (linecount != mediaDetails.end())
    {
        ...
        {
            cpLog(LOG_ERR, "Unknown field in the media portion %s",(*linecount).c_str());
...
void SdpMedia::setTransportType(TransportType newtransport)
{
