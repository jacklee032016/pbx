/*
 * $Id: VFilter.cxx,v 1.2 2007/03/01 20:04:32 lizhijie Exp $
 */
        ...
        useFilter(false)
{
    ...
    {
        cpDebug(LOG_INFO, "Environment variable SIP_FILTER is set." );
        cpDebug(LOG_INFO, "Using VFilter to modify SIP messages" );
        useFilter = true;
    }
    else
    {
        cpDebug(LOG_INFO, "Environment variable SIP_FILTER is Not set." );
        cpDebug(LOG_INFO, "Not using VFilter to modify SIP messages" );
    }
}
