/*
 * $Id: testDnsResolver.cxx,v 1.2 2007/03/01 20:04:32 lizhijie Exp $
 */
...
main(int argc, char* argv[])
{
	...
	// cpDebug(LOG_DEBUG, "Testing buildARecords()");
    ...
    {  
        ...
        for (int i=0; i<num; i++)
        {
           ...
           cpDebug(LOG_DEBUG, "Getting record #%d, target=%s",
                  i,(*rec)->getTarget() );
        }

        cpDebug(LOG_DEBUG, "********* Reordering the SRV list");
        srv.reOrder();
