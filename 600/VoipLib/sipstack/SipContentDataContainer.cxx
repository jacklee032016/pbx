/*
 * $Id: SipContentDataContainer.cxx,v 1.3 2007/03/02 06:25:54 lizhijie Exp $
 */
...
void SipContentDataContainer::setContentData(Sptr<SipContentData> contData, int index)
{
	assert( contData != 0 );
	cpDebug(LOG_DEBUG_STACK, "setContentData %d: %s", index, contData->encodeHeaders().logData() );

#ifndef __AS_RELEASE__
	int bodyLength;
	cpDebug(LOG_DEBUG_STACK, "\n%s", contData->encodeBody(bodyLength).logData() );
#else
#endif
