/*
 * $Id: SipUrl.cxx,v 1.4 2007/06/05 11:33:26 lizhijie Exp $
 */
...
bool SipUrl::setUserValue(const Data& newUser, const Data& newUserParam)
{
	if (user.getPtr() == 0)
	{
		...
		{
#if 0		/* changed for display name(company name) of contact field when register, lzj, 2007.03.17  */
