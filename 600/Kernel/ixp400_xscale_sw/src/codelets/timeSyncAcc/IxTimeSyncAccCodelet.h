 ...
 *
 * @brief This is the header file for IXP400 Time Sync Access Codelet
 *
 * @par 
 ...
 * @ingroup Codelets
 *
 * @defgroup IxTimeSyncAccCodelet IXP400 Time Sync Access Codelet  
 *
 * @brief IXP400 Time Sync Access Codelet 
 *
 * <PRE>
