 ...
 * @ingroup Codelets
 *
 * @defgroup IxEthAccCodelet IXP400 Ethernet Access Codelet (IxEthAccCodelet) API
 *
 * @brief IXP400 Ethernet Access Codelet API
 *
 ...
 * This codelet assumes that the underlying IXP400 Product Line Silicons have two Ethernet NPEs.
