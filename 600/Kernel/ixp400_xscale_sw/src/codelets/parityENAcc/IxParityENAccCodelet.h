 ...
 *
 * @brief This is the header file for IXP400 Parity Error Notifier 
 *	  Access Codelet
 *
 * @par
 ...
 * @ingroup Codelets
 *
 * @defgroup IxParityENAccCodelet IXP400 Parity Error Notifier Access Codelet 
 *
 * @brief IXP400 Parity Error Notifier Access Codelet 
 *
...
#define IX_PARITYENACC_CODELET_BIT_MASK_CHECK(data, mask) \
	 ...
	 *	  timer reset functionality, will be used to reboot the board.
 	 */
	#define IX_PARITYENACC_CODELET_REBOOT()  (sysToMonitorColdReboot())
...
#ifdef __vxworks
	extern int sysToMonitorColdReboot (void); 
