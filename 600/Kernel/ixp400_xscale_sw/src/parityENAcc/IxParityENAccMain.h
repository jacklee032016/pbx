...
/*
 * This macro is now replaced with a function in IxParityENAccMain.c
 */
#if 0
#define IXP400_PARITYENACC_INVOKE_CLIENT_CALLBACK()           \
do {                                                          \
 ...
 * Bits[2:0]-NPE-A,NPE-B,NPE-C; Bit[3]-MCU ECC; Bits[31:4] reserved
 */
