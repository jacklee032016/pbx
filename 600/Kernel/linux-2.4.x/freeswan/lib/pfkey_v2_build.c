 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_build.c,v 1.1.1.1 2006/11/29 08:55:38 lizhijie Exp $
 */
...
char pfkey_v2_build_c_version[] = "$Id: pfkey_v2_build.c,v 1.1.1.1 2006/11/29 08:55:38 lizhijie Exp $";
