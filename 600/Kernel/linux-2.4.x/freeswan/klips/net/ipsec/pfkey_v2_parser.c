 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_parser.c,v 1.1.1.1 2006/11/29 08:55:38 lizhijie Exp $
 */
...
char pfkey_v2_parser_c_version[] = "$Id: pfkey_v2_parser.c,v 1.1.1.1 2006/11/29 08:55:38 lizhijie Exp $";
