#!/bin/bash
#
# RCSID $Id: kernel.patch.gen.sh,v 1.1.1.1 2006/11/29 08:55:38 lizhijie Exp $
...
echo found $i
echo "RCSID \$Id: kernel.patch.gen.sh,v 1.1.1.1 2006/11/29 08:55:38 lizhijie Exp $" >$patchdir/$l
