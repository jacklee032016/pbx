...
char zft_src[] __initdata = "$Source: /CVS/CVS/ixp_works/as600_Kernel/linux-2.4.x/drivers/char/ftape/zftape/zftape-init.c,v $";
char zft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char zft_dat[] __initdata = "$Date: 2006/11/29 08:55:15 $";
