/*
 * $Id: Contact.cxx,v 1.2 2007/03/02 04:19:29 lizhijie Exp $
 */
...
Contact::Contact( const Contact& c )
        : inviteMsg( c.inviteMsg ), statusMsg( c.statusMsg )
{
    status = c.status;
    cSeqNum = c.cSeqNum;
...
///
void
Contact::update( const StatusMsg& msg )
{
...
///
bool
Contact::operator==( const SipMsg& msg )
{
...
///
void
Contact::setLastInfoCSeq( unsigned int cseq )
{
    lastInfoCSeq = cseq;
}
...
///
void
Contact::setCSeqNum( unsigned int cseq )
{
    cSeqNum = cseq;
}
...
///
void
Contact::setRemoteRingback( bool flag )
{
    remoteRingback = flag;
}
...
///
bool
Contact::getRemoteRingback() const
{
