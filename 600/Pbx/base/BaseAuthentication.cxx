/*
 * $Id: BaseAuthentication.cxx,v 1.4 2007/03/06 18:56:20 lizhijie Exp $
 */
...
void addProxyAuthorization(const StatusMsg& errorMsg,
		      SipCommand& cmdMsg,
                      Data username,
		      Data password)
{
...
void addWwwAuthorization(const StatusMsg& errorMsg,
		    SipCommand& cmdMsg,
                    Data username,
		    Data password)
{
