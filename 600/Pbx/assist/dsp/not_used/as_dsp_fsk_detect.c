/*
 * $Id: as_dsp_fsk_detect.c,v 1.1.1.1 2006/11/29 09:50:50 lizhijie Exp $
*/
#include "assist_globals.h"
#include "as_user_dsp.h"
#include "pbx_globals.h"

extern int as_fsk_serie(as_dsp_engine *dsp, int fd);
...
*/
static int __as_fsk_decode_gettdd(as_dsp_engine *dsp, int fd)
{
	int	b,c;
