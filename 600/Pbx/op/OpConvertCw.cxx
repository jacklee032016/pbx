/*
 * $Id: OpConvertCw.cxx,v 1.2 2007/03/02 04:19:27 lizhijie Exp $
 */
...
///
const Sptr < State >
OpConvertCw::process( const Sptr < SipProxyEvent > event )
{
