/*
 * $Id: OpHeldCallEndedDialing.cxx,v 1.2 2007/03/02 04:19:28 lizhijie Exp $
 */
...
OpHeldCallEndedDialing::OpHeldCallEndedDialing()
{}
...
const char* const
OpHeldCallEndedDialing::name() const
{
    return "OpHeldCallEndedDialing";
}


///
const Sptr < State >
OpHeldCallEndedDialing::process( const Sptr < SipProxyEvent > event )
{
