/*
 * $Id: OpBlindXferHoldOk.cxx,v 1.2 2007/03/02 04:19:27 lizhijie Exp $
 */
...
OpBlindXferHoldOk::OpBlindXferHoldOk()
{}
...
const char* const
OpBlindXferHoldOk::name() const
{
    return "OpBlindXferHoldOk";
}


///
const Sptr < State >
OpBlindXferHoldOk::process( const Sptr < SipProxyEvent > event )
{
