/*
 * $Id: OpStopRinging.cxx,v 1.2 2007/03/02 04:19:28 lizhijie Exp $
 */
...
OpStopRinging::OpStopRinging()
{}


///
const Sptr < State >
OpStopRinging::process( const Sptr < SipProxyEvent > event )
{
...
///
const char* const
OpStopRinging::name() const
{
    return "OpStopRinging";
}
