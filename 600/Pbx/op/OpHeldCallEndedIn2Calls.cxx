/*
 * $Id: OpHeldCallEndedIn2Calls.cxx,v 1.2 2007/03/02 04:19:28 lizhijie Exp $
 */
...
OpHeldCallEndedIn2Calls::OpHeldCallEndedIn2Calls()
{}
...
const char* const
OpHeldCallEndedIn2Calls::name() const
{
    return "OpHeldCallEndedIn2Calls";
}


///
const Sptr < State >
OpHeldCallEndedIn2Calls::process( const Sptr < SipProxyEvent > event )
{
    cpDebug(LOG_DEBUG, "OpHeldCallEndedIn2Calls operation" );
