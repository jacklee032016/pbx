/*
 * $Id: OpXferComplete.cxx,v 1.2 2007/03/02 04:19:28 lizhijie Exp $
 */
...
const char* const
OpXferComplete::name() const
{
    return "OpXferComplete";
}


///
const Sptr < State >
OpXferComplete::process( const Sptr < SipProxyEvent > event )
{
