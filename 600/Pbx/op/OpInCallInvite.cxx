/*
 * $Id: OpInCallInvite.cxx,v 1.4 2007/03/16 19:33:56 lizhijie Exp $
 */
...
const char* const
OpInCallInvite::name() const
{
    return "OpInCallInvite";
}


const Sptr <State> OpInCallInvite::process( const Sptr <SipProxyEvent> event )
{
