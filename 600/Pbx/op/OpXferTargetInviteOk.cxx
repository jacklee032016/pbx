/*
 * $Id: OpXferTargetInviteOk.cxx,v 1.2 2007/03/02 04:19:28 lizhijie Exp $
 */
...
OpXferTargetInviteOk::OpXferTargetInviteOk()
{}
...
const char* const
OpXferTargetInviteOk::name() const
{
    return "OpXferTargetInviteOk";
}


///
const Sptr < State >
OpXferTargetInviteOk::process( const Sptr < SipProxyEvent > event )
{
