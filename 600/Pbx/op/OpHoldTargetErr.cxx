/*
 * $Id: OpHoldTargetErr.cxx,v 1.2 2007/03/02 04:19:28 lizhijie Exp $
 */
...
OpHoldTargetErr::OpHoldTargetErr()
{}
...
const char* const
OpHoldTargetErr::name() const
{
    return "OpHoldTargetErr";
}


///
const Sptr < State >
OpHoldTargetErr::process( const Sptr < SipProxyEvent > event )
{
