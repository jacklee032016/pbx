/*
 * $Id: OpAckReInvite.cxx,v 1.3 2007/03/03 18:39:27 lizhijie Exp $
 */
...
const char* const
OpAckReInvite::name() const
{
    return "OpAckReInvite";
}


const Sptr < State >
OpAckReInvite::process( const Sptr < SipProxyEvent > event )
{
