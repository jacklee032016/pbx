#ifndef __AS_USER_DSP_H__
#define __AS_USER_DSP_H__
...
as_dtmf_detector *as_dsp_init_dtmf_detect( int law, int sample_length);
void as_dsp_detsory_dtmf_detect(as_dtmf_detector *dsp);

as_dsp_engine *as_dsp_init_dsp(int fd, int law );
void as_dsp_detsory_dsp(as_dsp_engine *dsp);

int as_fsk_clid( as_dsp_engine *dsp, int fd, char *number, char *name );
