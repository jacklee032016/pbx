/*$Id: cgiStcMain.c,v 1.4 2007/06/21 20:30:02 lizhijie Exp $*/
...
int main(int argc, char *argv[])
{
	...
	stc_setup_pbx_when_startup(&pbxentries);

	ret=pthread_create(&id,NULL,(void *)stc_read_serial_cmd_thread,NULL);
 	if(ret!=0)
 	{
...
//	pbx_write_com(&pbxentries);
	...
	cgi_signal_register_handler(SIG_PBX_CGI, stc_handler_cgisig );

#if 0	
	pbx_send_comcmd(CMD_CFG_IP_PBX_GET_ALL_CFGS, NULL, NULL);     //get system parameter
