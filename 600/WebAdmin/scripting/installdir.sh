...
DIRS="/var/www/cgi-bin /var/admin/data /var/admin/cgi-bin /var/admin/cgi-bin/sip /var/admin/cgi-bin/system /var/admin/cgi-bin/servers /var/admin/cgi-bin/services /var/admin/cgi-bin/network /lib /usr/bin /dev"
