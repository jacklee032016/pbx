/*
* $Id: uart_cmd.h,v 1.7 2007/09/13 16:55:44 lizhijie Exp $
*/
#ifndef	__UART_CMD_H__
#define	__UART_CMD_H__

#define	WITH_EXT_DIFFER_RINGING				0
...
#define		CALLID_MODE_ON				1	/* PSTN CallerID is enable */
#define		CALLID_MODE_OFF				0	/* PSTN CallerID is disable, default */
...
#define	CMD_CFG_CONSOLE_PHONENUMBER				0xBD
#define	CMD_CFG_CONSOLE_EXT_INDEX					0xBE
...
#define	UART_DEBUG_STATE							0x02
#define	UART_DEBUG_ROW_RESOURCE				0x03
#define	UART_DEBUG_COL_RESOURCE					0x04
#define	UART_DEBUG_SELFTEST						0x05
#define	UART_DEBUG_STSTIME						0x06
#define	UART_DEBUG_PSTN_RINGER					0x07
#define	UART_DEBUG_CAR							0x08
#define	UART_DEBUG_BUSY_DETCET					0x09
#endif
