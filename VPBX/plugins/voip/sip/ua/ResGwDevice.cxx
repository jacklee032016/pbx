/*
* $Id: ResGwDevice.cxx,v 1.1.1.1 2006/11/30 16:26:29 lizhijie Exp $
*/
...
//	digitCollector = new DigitCollector(AS_DEVICE_NOT_DEFINED, outputQ );
    ...
    if ( PbxConfiguration::instance()->getUsePolicyServer() )
    {
        try
        {
            string psHost = PbxConfiguration::instance()->getProvisioningHost();
            int psPort = PbxConfiguration::instance()->getProvisioningPort();
...
void ResGwDevice::reportEvent( DeviceEventType eventType , int deviceId, const string& number )
{
