#if !defined(ASSIST_CONTROL_EVENT_HXX)
#define ASSIST_CONTROL_EVENT_HXX
/*
* $Id: ControlEvent.hxx,v 1.1.1.1 2006/11/30 16:26:29 lizhijie Exp $
*/
 ...
 *  @see    FifoBase
 */
class ControlEvent : public Assist::Services::Event
{
    public:
...
#endif // !defined(ASSIST_CONTROL_EVENT_HXX)
