...
#define	SERVER_CONFIG_FILE						"/etc/mediaServer.conf"
#define	CAMERA_CONFIG_FILE						"/etc/sys/camera.conf"
#define	RECORD_CONFIG_FILE						"/etc/web/autorecord.conf"
#define	ACTIVE_CTRL_FILE							"/etc/InitialSnrActive.cfg"
...
#define 	CAMERA_DECRIP_CONF						"/etc/web/descrip.conf"
