...
#define	CGIDATA_DATA_BACKUP_PREFIX					"web_back"          /* prefix of backup data file name */
#define	CGIDATA_SOFT_UPLOAD_PREFIX					"web_soft"            /* prefix of auto upload software file name */

#define	CGIDATA_BACKUP_DATA_DIR						"data"
#define	CGIDATA_BACKUP_DIRS							"/etc/* /tmp/log/* "          /* /usr/etc  /tmp/data   */
