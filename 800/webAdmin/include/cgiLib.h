/*
* cgiLib.h - header file for cgi-lib.c
* $Author: lizhijie $
* $Revision: 1.37 $
*/
...
#define	REBOOT_WAIT_TIME			30	/* seconds */
...
#define	WEB_URL_SYSCONFIG				WEB_CGI_ROOT"system/sysconf.cgi"
...
#define		CGI_STR_FF_SERVER				_("FF Server")
