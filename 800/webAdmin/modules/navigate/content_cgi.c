...
static char *__content_status()
{
	...
	length += CGI_SPRINTF(buf,length, "<div align=\"right\"> <font color=\"#0066FF\"size=\"2\">%s</font></div> \n</div>\n",gettext("SONiX technolocy co ltd"));
	length += CGI_SPRINTF(buf,length, "<div id=\"Layer1\" style=\"position:absolute; left:621px; top:475px; width:170px; height:9px; z-index:2\"><a href=\"http://www.sonix.com.tw\"><font size=\"2\" face=\"Times New Roman\">http://www.SONiX.com.tw</font></a></div>\n");
	...
	length += CGI_SPRINTF(buf,length, "&nbsp;&nbsp;&nbsp;%s</strong></font><strong><font size=\"5\" face=\"Times New Roman, Times, seri\">--<font size=\"6\">IP Camera</font></font></strong></div></td></tr>\n",
		gettext("SONiX SoC"));
	...
	length += CGI_SPRINTF(buf,length, "<tr><td rowspan=\"9\"><div align=\"right\"></div><div align=\"right\"></div></td>\n<td height=\"26\">%s</td></tr>\n",
		gettext("support RTSP, RTP,PPPoE,DHCP,ICMP,NAT,UPnP,WiFi"));
	length += CGI_SPRINTF(buf,length, "<tr><td height=\"26\">%s</td></tr>\n", gettext("support JPEG, MJPEP, MPEG4, Motion Detection etc.") );
	...
	length += CGI_SPRINTF(buf,length, "<tr><td height=\"26\">%s</td></tr>\n",gettext("Support MAIL and FTP alert"));
	
	length += CGI_SPRINTF(buf,length, "<tr><td height=\"26\">%s%s</td></tr>\n",gettext("The powerful Web management function"),gettext("and support i18n framework"));
