 ...
 * AS800 U-Boot
 *
 * Revision 1.1.1.1  2006/01/23 06:08:14  wangwei
 * no message
 *
 * Revision 1.4  2005/01/25 10:06:35  lizhijie
 * debug the problem of appending '=' in bootargs and bootcms commands
 *
 * $Id: cmd_nvedit.c,v 1.1.1.1 2006/11/30 16:25:16 lizhijie Exp $
 */
...
/* change this line as following for the 'setenv' command : which append '=' between 2 args 
 * Li Zhijie 2005.01.25 
*/
//		*env = (i==2) ? '=' : ' ';

#if 0
		printf("argv[%d]=%s \r\n", i, argv[i] );
		printf("res1 =%d res2 = %d\r\n", strncmp(argv[1],  "bootcmd" ,7), strncmp(argv[1],  "bootarg" ,7) );
#endif
		if( i==2 
			&&  strncmp(argv[1],  "bootcmd" ,7) 
			&&  strncmp(argv[1],  "bootarg" ,7)    )
		{
			*env =  '=';
		}	
		else 
...
int i;
	...
	if( argc>=2  && 
		( (strncmp(argv[1], "bootcmd" ,7)==0 ) 
		 || (strncmp(argv[1], "bootarg" ,7)==0 )  )
	{
