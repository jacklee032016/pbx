 ...
 *
 * $Id: serial.c,v 1.1.1.1 2006/11/30 16:25:16 lizhijie Exp $
 */
...
{
/* added by lizhijie, 2005.06.14 */
	extern void beep_ok(void );
/* end of added by lizhijie */	

	serial_setbrg ();

/* following is added for the first beep when power-on , lizhijie, 2005.06.14 */
//	serial_puts ("Beep...\n");
	beep_ok();
/*	serial_puts ("End Beep\n"); */
/* end of added by lizhijie */
	return (0);
}
