/*
* $Id: DatagramSocket.cxx,v 1.1.1.1 2006/11/30 16:27:10 lizhijie Exp $
*/
...
throw ( Assist::SystemException )
{
    ...
    {
    	throw Assist::SystemException(fn + " on connect(): " + strerror(errno), 
...
throw ( Assist::SystemException )
{
    ...
    {
    	throw Assist::SystemException(fn + " on disconnect(): " + strerror(errno), 
	    	    	    	__FILE__, __LINE__, errno);
    }
...
throw ( Assist::SystemException, Assist::SystemStatus )
{
	...
	{
            throw Assist::SystemException(fn + " on recvfrom(): incorrect address type", 
	    	    	    	__FILE__, __LINE__);
	}
    }
    else
