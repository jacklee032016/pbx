/*
* $Id: Poll.cxx,v 1.1.1.1 2006/11/30 16:27:10 lizhijie Exp $
*/
...
using Assist::Transport::pollfdLess;
...
throw ( Assist::SystemException )
{
    	...
    	if ( error == EINTR )
	{
    	...
    	throw Assist::SystemException(fn + " on poll(): " + strerror(error), 
