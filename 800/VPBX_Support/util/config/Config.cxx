/*
* $Id: Config.cxx,v 1.1.1.1 2006/11/30 16:27:10 lizhijie Exp $
*/
...
using Assist::Configuration::NO_VALUE;
using Assist::Configuration::VALUE_PRESENT;
using Assist::Configuration::VALUE_OPTIONAL;
