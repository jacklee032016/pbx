/*
* $Id: CommandLine.cxx,v 1.1.1.1 2006/11/30 16:27:10 lizhijie Exp $
*/
...
#define ASSIST_VERSION "1.0.0alpha2 (CVS)"
...
const pair < const char*, const char* > CommandLine::cmdLineOptionString[] =
{
    ...
    pair < const char*, const char* > ("CONFFILE", ASSIST_INSTALL_PATH "/etc/vocal.conf"),
    pair < const char*, const char* > ("CONFDIR", ASSIST_INSTALL_PATH "/etc"),
};
...
# endif 
...

    {
        ...
        if(c == 'V')
        {
            printf("ASSIST version %s(%s  %s)\n", ASSIST_VERSION, __DATE__ , __TIME__);
//            printf("ASSIST version %s\n", ASSIST_VERSION);
