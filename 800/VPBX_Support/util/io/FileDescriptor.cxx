/*
* $Id: FileDescriptor.cxx,v 1.1.1.1 2006/11/30 16:27:10 lizhijie Exp $
*/
...
throw ( Assist::SystemException )
{
    ...
    {
    	throw Assist::SystemException(fn + " on fcntl(): " + strerror(errno), 
...
throw ( Assist::SystemException )
{
    ...
    {
    	fd_ = INVALID;
    	throw Assist::SystemException(fn + " on std::close(): " + strerror(errno), 
	    	    	    	__FILE__, __LINE__, errno);
    }
...
throw ( Assist::SystemException, Assist::SystemStatus )
{
	...
	{
    	    throw Assist::SystemStatus(fn + " on write(): " + strerror(error),
	    	    	    	__FILE__, __LINE__, error);
    	}	

    	throw Assist::SystemException(fn + " on write(): " + strerror(error), 
	    	    	    	__FILE__, __LINE__, error);
    }
...
throw ( Assist::SystemException, Assist::SystemStatus )
{
	...
	if ( error == EAGAIN || error == EINTR )
	{
    	    throw Assist::SystemStatus(fn + " on read(): " + strerror(error),
	    	    	    	__FILE__, __LINE__, error);
    	}	

    	throw Assist::SystemException(fn + " on read(): " + strerror(error), 
	    	    	    	__FILE__, __LINE__, error);
    }
