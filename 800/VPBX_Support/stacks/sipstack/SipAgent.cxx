...
*
* $Id: SipAgent.cxx,v 1.1.1.1 2006/11/30 16:27:09 lizhijie Exp $
*/
...
using namespace Assist::Threads;
...
{
    cpDebug(LOG_DEBUG_STACK, "updateSipCounter %d", inCounterName);
    TableIter aCounter;
    ...
    {
        aCounter->second ++;
        cpDebug(LOG_DEBUG_STACK, "new value = %d", aCounter->second);
        return voSuccess;
    }
    else
    {
...
SipAgent::getSipCounter(AgentApiMibVarT counter)
{
    ...
    if ( aCounter != SipCountersTable.end() )
    {
        ...
        cpDebug(LOG_DEBUG_STACK, "returning value = %d", aCounter->second);
    }
    else
    {
