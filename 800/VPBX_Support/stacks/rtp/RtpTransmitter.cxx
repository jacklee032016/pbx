...
*
* $Id: RtpTransmitter.cxx,v 1.1.1.1 2006/11/30 16:27:09 lizhijie Exp $
*/
                                       ...
                                       RtpPacket* p, bool print)
{
    ...
    switch (newtype)
    {
        ...
        break;
        case rtpPayloadG729:
        if( print) cpDebug(LOG_DEBUG, "Setting network format to: G729 %d", no_samples);
        networkFormat_clockRate = 8000;
        break;
        default:
