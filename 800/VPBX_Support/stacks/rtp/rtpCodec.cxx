...
*
* $Id: rtpCodec.cxx,v 1.1.1.1 2006/11/30 16:27:09 lizhijie Exp $
*/
    ...
    switch (fromType)
    {
                ...
                case rtpPayloadL16_8k_mono :
		{
		    ...
		    break;
                ...
                default :
                cpDebug(LOG_DEBUG, "Unsupported converstion %d -> %d",
                      fromType, toType);
                break;
            }
        }
                ...
                case rtpPayloadPCMU :
		{
		    ...
		    break;
                ...
                default :
                cpDebug(LOG_DEBUG, "Unsupported conversion %d -> %d",
                      fromType, toType);
                break;
            }
        }
...
char* findSilenceCodec( RtpPayloadType type, int len )
{
    for( int i = 0; i < numRtpCodecInfo; i++ )
    {
        ...
        {
            cpDebug(LOG_DEBUG_STACK, "Silence packet template found at index %d",
                   i );
