...
*
* $Id: Sdp2Session.hxx,v 1.1.1.1 2006/11/30 16:27:09 lizhijie Exp $
*/
...
/** 
    ...
    connection.setAddressType(Assist::SDP::AddressTypeIPV4); // the IP4
    ...
    sdpDesc.setAddressType(Assist::SDP::AddressTypeIPV4); // the IP4
    ...
    media->setMediaType(Assist::SDP::MediaTypeAudio); 
    // responsible for the 3456
    media->setPort( 3456 );
    // RTP/AVP
    media->setTransportType(Assist::SDP::TransportTypeRTP);
