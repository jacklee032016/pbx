#if !defined(ASSIST_CONFIG_HXX)
#define ASSIST_CONFIG_HXX
/*
* $Id: Config.hxx,v 1.1.1.1 2006/11/30 16:27:09 lizhijie Exp $
*/
...
using Assist::Threads::RWMutex;
using Assist::ReturnCode;
//using Assist::Configuration::GetOpt;
//using Assist::Configuration::NameValueMap;


/** 
 */
class Config : public Assist::IO::Writer
{
    public:
...
#endif // !defined(ASSIST_CONFIG_HXX)
