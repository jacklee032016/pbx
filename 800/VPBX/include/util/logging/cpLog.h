...
#define CPLOG_H
/*
* $Id: cpLog.h,v 1.1.1.1 2006/11/30 16:26:29 lizhijie Exp $
*/

/**
@name cpLog.h
Functions to facilitate logging errors and diagnostic messages, modeled after
the priority system of Unix syslog and used by all ASSIST servers
@author see CVS
*/
...
The additional log levels are specific to ASSIST.
*/
