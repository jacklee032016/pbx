...
const Sptr <State> VoipOpBeingXferred::process( const Sptr < SipProxyEvent > event )
{
    ...
    from.setUser( Data(callernum)); //Data( PbxConfiguration::instance()->getUserName() ) );
...
//    myUrl.setPhoneNumber( PbxConfiguration::instance()->getUserName() );
//    myUrl->setUserValue( PbxConfiguration::instance()->getUserName(), "phone" );
    ...
    if ( sipSdp != 0 )
    {
        ...
        //sipSdp->setRtpPort( atoi (PbxConfiguration::instance()->getLocalRtpPort().c_str() )  );
