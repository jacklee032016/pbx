/*
* $Id: l3ins.h,v 1.1.1.1 2006/11/30 16:26:29 lizhijie Exp $
*
*
*  Japanese INS D-channel protocol defines, based on DSS1 (Euro) 
*/

#ifndef l3nins_process
...
#define	IE_CODESET_4				(IE_SHIFT|0x04)
#define	IE_CODESET_5				(IE_SHIFT|0x05)
#define 	IE_CODESET_6				(IE_SHIFT|0x06)
#define	IE_CODESET_7				(IE_SHIFT|0x07)
/* IEs in codeset 6 */
#define IE_ADVISE_CHARGE				0x01	/* INS specs p.359 */
