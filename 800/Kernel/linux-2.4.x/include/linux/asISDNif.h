/* $Id: asISDNif.h,v 1.1.1.1 2006/11/30 16:29:07 lizhijie Exp $
 *
 */
...
#define DEFAULT_PORT_QUEUELEN			512
...
typedef struct _AS_ISDNobject	AS_ISDNobject_t;
typedef struct _AS_ISDNinstance	AS_ISDNinstance_t;
typedef struct _AS_ISDNlayer	AS_ISDNlayer_t;
typedef struct _AS_ISDNstack	AS_ISDNstack_t;
typedef struct _AS_ISDNport	AS_ISDNport_t;
typedef struct _AS_ISDNdevice	AS_ISDNdevice_t;
...
extern int	AS_ISDN_SetIF(AS_ISDNinstance_t *, AS_ISDNif_t *, u_int, void *, void *, void *);
extern int	AS_ISDN_ConnectIF(AS_ISDNinstance_t *, AS_ISDNinstance_t *);
extern int	AS_ISDN_DisConnectIF(AS_ISDNinstance_t *, AS_ISDNif_t *);

/* global register/unregister functions */

extern int	as_isdn_register(AS_ISDNobject_t *obj);
extern int	as_isdn_unregister(AS_ISDNobject_t *obj);
