 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_ext_bits.c,v 1.1.1.1 2006/11/30 16:28:44 lizhijie Exp $
 */
...
char pfkey_v2_ext_bits_c_version[] = "$Id: pfkey_v2_ext_bits.c,v 1.1.1.1 2006/11/30 16:28:44 lizhijie Exp $";
