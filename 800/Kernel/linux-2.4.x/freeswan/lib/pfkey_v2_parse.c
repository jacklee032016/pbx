 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_parse.c,v 1.1.1.1 2006/11/30 16:28:44 lizhijie Exp $
 */
...
char pfkey_v2_parse_c_version[] = "$Id: pfkey_v2_parse.c,v 1.1.1.1 2006/11/30 16:28:44 lizhijie Exp $";
