...
$Author: lizhijie $
$Log: main.c,v $
Revision 1.1.1.1  2006/11/30 16:29:09  lizhijie
AS800 Kernel

Revision 1.1.1.1  2006/01/10 06:01:04  lizhijie
kernel and driver for DUX project

Revision 1.1.1.1  2005/07/08 09:46:06  lizhijie
Linux-2.4.24 integrated Intel Access Library 2.0

Revision 1.5  2004/10/21 08:15:28  lizhijie
Ctest CVS ci command
VS: ----------------------------------------------------------------------

Revision 1.4  2004/10/21 08:14:28  lizhijie
...
#if 0
void __init display_mac_address(void)
{
	int j=0;
	
	for(j=0; j<MAX_INIT_ENVS+2; j++)
	{
		printk("init envp[%d] is '%s'\r\n", j, envp_init[j]);
	}
}
#endif
