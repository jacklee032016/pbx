/* $Id: helper.h,v 1.1.1.1 2006/11/30 16:28:15 lizhijie Exp $
 *
...
static inline void mISDN_sethead(u_int prim, int dinfo, struct sk_buff *skb)
{
...
static inline int if_newhead(mISDNif_t *i, u_int prim, int dinfo, struct sk_buff *skb)
{
	if (!i->func || !skb)
		return(-ENXIO);
