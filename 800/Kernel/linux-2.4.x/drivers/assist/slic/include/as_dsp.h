 ...
 * AS800 Kernel
 *
 * Revision 1.4  2006/04/19 12:33:50  lizhijie
 * add CAR support for both FXS/FXO and debugs
 *
 * Revision 1.3  2006/04/19 12:31:25  lizhijie
 * no message
 *
 * Revision 1.2  2006/03/13 02:46:11  lizhijie
 * modify the tone defination for NTT's NFT,CPT,SDT,IIT
 *
...
//	AS_TONE_ZONE_DEFAULT 	=-1,	/* To restore default */
	...
	AS_TONE_CALLWAIT		=	4,
	AS_TONE_DIALRECALL	=	5,		/* SDT(Second Dial Tone) for japan */
	AS_TONE_RECORDTONE	=	6,
	AS_TONE_INFO			=	7,
	AS_TONE_CUST1			=	8,		/* defined as CPT(Acceptance) and NFT(Notification) for Japan , lizhijie, 2006.03.12 */
	AS_TONE_CUST2			=	9,		/* defined as IIT(Incomming Identification) for Japan, Lizhijie,2006.03.12 */
	AS_TONE_STUTTER		=	10
}as_tone_type_t;
...
struct as_zone_tones_data 
{
	...
	int 	ringcadence[AS_MAX_CADENCE];
	int 	carcadence[AS_MAX_CADENCE];	/* CAR Cadence, 2006.04.17 */
