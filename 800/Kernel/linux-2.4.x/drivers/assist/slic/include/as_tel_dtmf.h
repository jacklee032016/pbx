 ...
 * $Revision: 1.1.1.1 $
*/
#ifndef __AS_TEL_DTMF_H__
#define __AS_TEL_DTMF_H__

#define AS_DTMF_DETECT_UNVALIDATE	0
#define AS_DTMF_DETECT_VALIDATE		1

struct as_dtmf_input
{
	unsigned char dtmf_incoming;
	unsigned char dtmf_current;
};
