 ...
 * AS800 Kernel
 *
 * Revision 1.6  2006/04/19 12:33:50  lizhijie
 * add CAR support for both FXS/FXO and debugs
 *
 * Revision 1.5  2006/04/19 12:31:25  lizhijie
 * no message
 *
 * Revision 1.4  2006/01/17 03:19:42  lizhijie
 * a
 *
 * Revision 1.3  2006/01/16 06:42:55  lizhijie
 * dd
 *
...
#endif
/* interrupt is change from 1 ms to 10 ms, so bounce change to 6. for about 60 ms 
 * lizhijie, 2005.01.15 
*/
//#define RING_DEBOUNCE		(60*AS_TIME_UNIT)		/* Ringer Debounce (in ms) */
#define BATT_DEBOUNCE		(60*AS_TIME_UNIT)		/* Battery debounce (in ms) */

#define	OH_DEBOUNCE		(350*AS_TIME_UNIT)		/* for off-hook debounce timer, lizhijie, 2006.03.24 */

#define BATT_THRESH			3		/* Anything under this is "no battery" */
/* changed as 45 voltage from test, lizhijie,2006.03.25 */
//#define BATT_THRESH			10		/* Anything under this is "no battery" */

#if 0
#define OHT_TIMER			6000	/* How long after RING to retain OHT */
#endif

#define OHT_TIMER			(600*AS_TIME_UNIT)		/* How long after RING to retain OHT */
...
#define MINPEGTIME						1 * 8		/* 30 ms peak to peak gets us no more than 100 Hz */
#define PEGTIME							5 * 8		/* 50ms peak to peak gets us rings of 10 Hz or more */
#define PEGCOUNT						5		/* 5 cycles of pegging means RING */

#define NUM_CAL_REGS 					12


#define 	E_NOT_PROSLIC					2
#define	E_INDIRECT_REG_FAIL			1
...
struct wcfxs 
{
	...
	union 
	{
		struct 
		{
			...
			int ohdebounce[NUM_CARDS];

			int onhook[NUM_CARDS];
			...
			/* offhook delay in order to clear DTMF data in DMA buffer ,default is 100ms ,lizhijie,2006.01.16 */
			int offhookTimer[NUM_CARDS];
...
#define	FXO_REG2_RDI_MODE		0x04

#define	FXO_REG4_RDTI				0x80

#define	FXO_REG5_RDTN				0x40
#define	FXO_REG5_RDTP				0x20
#define	FXO_REG5_ONHM				0x08	/* on-hook Linke monitor */
#define	FXO_REG5_RDT				0x04	/* ring burst */
#define	FXO_REG5_OH				0x01	/* off-hook control */
#endif
