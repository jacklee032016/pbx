/*
 * $Id: l3_uins_if.c,v 1.1.1.1 2006/11/30 16:27:58 lizhijie Exp $
 */
...
int ins_fromdown(as_isdn_if_t *hif, struct sk_buff *skb)
{
	layer3_t			*l3;
...
int ins_fromup(as_isdn_if_t *hif, struct sk_buff *skb)
{
	layer3_t	*l3;
	int		cr, ret = -EINVAL;
	l3_process_t	*proc;
