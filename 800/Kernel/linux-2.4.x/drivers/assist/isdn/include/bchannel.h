/*
 * $Id: bchannel.h,v 1.1.1.1 2006/11/30 16:27:58 lizhijie Exp $
...
#define RAWDEV_PENDING_SKB_SIZE		400
...
//	struct semaphore		io_sema;
	...
	struct sk_buff		*last_skb;							/* last read skb which some data is still not used now */
	
	struct sk_buff		*pending_tx_skb;					/* skb waiting more data to tx */
	int					currentPosition;						/* current position of pending skb */
};

#define  BCHANNEL_READ_LENGTH			160
