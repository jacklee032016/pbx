/* $Id: hw_lock.h,v 1.1.1.1 2006/11/30 16:27:58 lizhijie Exp $
 *
...
typedef struct _AS_ISDN_HWlock {
	u_long			flags;
	spinlock_t		lock;
#ifdef SPIN_DEBUG
	void			*spin_adr;
 ...
 */
static inline int lock_HW(AS_ISDN_HWlock_t *lock, int nowait)
{
...
static inline void unlock_HW(AS_ISDN_HWlock_t *lock)
{
...
static inline void lock_HW_init(AS_ISDN_HWlock_t *lock)
{
