/*
 $Author: lizhijie $
 $Log: siimage.c,v $
 Revision 1.1.1.1  2006/11/30 16:28:14  lizhijie
 AS800 Kernel

 Revision 1.1.1.1  2006/01/10 06:01:05  lizhijie
 kernel and driver for DUX project

 Revision 1.1.1.1  2005/07/08 09:46:08  lizhijie
 Linux-2.4.24 integrated Intel Access Library 2.0

 Revision 1.2  2004/10/21 08:31:56  lizhijie
 Cdd kernel siimage 680 supportkerVS: ----------------------------------------------------------------------
...
/* make the IDE module work in the CLK of 66 MHZ */
//	pci_write_config_byte(dev, 0x8A, 0x20);
