/*
* $Id: ixp400_eth_adm.c,v 1.1.1.1 2006/11/30 16:28:19 lizhijie Exp $
...
#define MODULE_NAME "ixp400_eth_adm"
...
/* this item must be modified when WAN as eth0 and eth1, lizhijie, 2005.11.23 */
	...
	/*add , wangwei , 2006.01.16*/
	priv->port_id  = default_portId[RAW_WAN_POSITION];
#else
