/*
 $Author: lizhijie $
 $Log: ixp425_eth.c,v $
 Revision 1.1.1.1  2006/11/30 16:28:19  lizhijie
 AS800 Kernel

 Revision 1.1.1.1  2006/01/10 06:01:06  lizhijie
 kernel and driver for DUX project

 Revision 1.1.1.1  2005/07/08 09:46:09  lizhijie
 Linux-2.4.24 integrated Intel Access Library 2.0

 Revision 1.5  2005/01/25 13:33:08  lizhijie
 Cremove MAC from command lineVS: ----------------------------------------------------------------------

 Revision 1.4  2004/10/21 13:07:15  lizhijie
 CRemove odd prompt when bootVS: ----------------------------------------------------------------------

 Revision 1.3  2004/10/08 08:06:13  lizhijie
 Cadd MAC Address set dynamically
 VS: ----------------------------------------------------------------------
...
/* added by lizhijie 2004.10.21 */		
	printk("\tPlease check your MAC address configuration in Bootloader carefully\r\n");
...
int init_module(void)
{
	...
	if ((res = qmgr_init()))
	    return res;
        TRACE;
/* comment this prompt . lizhijie 2004.07.06 */
#if 0  
