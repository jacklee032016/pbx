 ...
 * Revision history:
 * $Log: sx.c,v $
 * Revision 1.1.1.1  2006/11/30 16:28:02  lizhijie
 * AS800 Kernel
 *
 * Revision 1.1.1.1  2006/01/10 06:01:09  lizhijie
 * kernel and driver for DUX project
 *
 * Revision 1.1.1.1  2005/07/08 09:46:13  lizhijie
...
#define RCS_ID "$Id: sx.c,v 1.1.1.1 2006/11/30 16:28:02 lizhijie Exp $"
