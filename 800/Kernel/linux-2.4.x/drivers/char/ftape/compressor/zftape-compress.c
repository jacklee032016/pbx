 ...
 */
 ...
 char zftc_src[] ="$Source: /CVS/CVS/ixp_works/as800_Kernel/linux-2.4.x/drivers/char/ftape/compressor/zftape-compress.c,v $";
 char zftc_rev[] = "$Revision: 1.1.1.1 $";
 char zftc_dat[] = "$Date: 2006/11/30 16:28:03 $";
