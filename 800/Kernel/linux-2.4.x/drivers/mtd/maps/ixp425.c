...
/* now it is defined by 'make config', lizhijie, 2006.01.19
#define WINDOW_SIZE	0x0400000
*/
#define WINDOW_SIZE	CONFIG_ASSIST_FLASH_SIZE
...
//		offset:	0x00030000,
//		size:	0x00180000, 
 		offset:	CONFIG_ASSIST_FLASH_BOOT,
		size:	CONFIG_ASSIST_FLASH_KERNEL, 
   	},
...
//		offset:	0x001B0000,
//		size:	0x00250000, 
		offset:	(CONFIG_ASSIST_FLASH_BOOT+CONFIG_ASSIST_FLASH_KERNEL),
		size:	CONFIG_ASSIST_FLASH_ROOTFS, 
	},
