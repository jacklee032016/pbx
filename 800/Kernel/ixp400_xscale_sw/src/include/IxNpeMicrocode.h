...
/*
 comment by lizhijie, 2005.07.13, 
 uncomment for IxCryptoAccCodelet.c even no NPEA is provided in IXP422 , 2005.07.18
*/
#if IX_NPE_IMAGE_INCLUDE
/**
...
#if IX_NPE_IMAGE_INCLUDE
/**
 * @def IX_NPEDL_NPEIMAGE_NPEC_CRYPTO_AES_ETH_LEARN_FILTER_SPAN_FIREWALL
 *
 * @brief NPE Image Id for NPE-C with AES Crypto and Basic Ethernet Rx/Tx which includes: MAC_FILTERING, MAC_LEARNING, SPANNING_TREE, FIREWALL
 */
#define IX_NPEDL_NPEIMAGE_NPEC_CRYPTO_AES_ETH_LEARN_FILTER_SPAN_FIREWALL 0x02040200
#endif
...
/*
 There are 8 firmware images for NPE B and C,
 total 17 firmwarw images for all NPEs(A,B and C)
 Lizhijie, 2005.07.11
*/ 

/* Number of NPE firmware images in this library */
/*
#define IX_NPE_MICROCODE_AVAILABLE_VERSIONS_COUNT 21
*/
/* changed as following ( from 8 to 11 )after NpeCrypt library added, lizhijie, 2005.07.13  */
#define IX_NPE_MICROCODE_AVAILABLE_VERSIONS_COUNT 11  /* 8 */
