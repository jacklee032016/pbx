...
linuxbe_KERNEL_DIR=$TOP_DIR/linux-2.4.x
linuxle_KERNEL_DIR=$TOP_DIR/linux-2.4.x
...
IX_XSCALE_SW=$TOP_DIR/ixp400_xscale_sw
...
export linuxbe_KERNEL_DIR linuxle_KERNEL_DIR HARDHAT_BASE IX_XSCALE_SW IX_DEVICE IX_PLATFORM IX_TARGET
