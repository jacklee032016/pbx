...
mknod $RELEASES_ROOT/dev/ptyp1   c 2 1
mknod $RELEASES_ROOT/dev/ttyp1   c 3 1
mknod $RELEASES_ROOT/dev/ptyp2   c 2 2
mknod $RELEASES_ROOT/dev/ttyp2   c 3 2  
mknod $RELEASES_ROOT/dev/ptyp3   c 2 3  
mknod $RELEASES_ROOT/dev/ttyp3   c 3 3  
