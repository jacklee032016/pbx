...
RELEASES_ROOT=$RELEASES_FLASH/flash4usb
REPOSITORY=$RELEASES_HOME/flash4usb.tar.gz

# 2368K jffs2 root fs partition
IMAGE_SIZE=14942208
#14942208
#2424832
OUTPUT_FILE=jffs2.big.usb.image
...
#tar zxvf $RELEASES_HOME/$REPOSITORY
...
echo ""
tar zxvf $REPOSITORY
cp -R $RELEASES_ROOT/flash4usb/* $RELEASES_ROOT/ 
