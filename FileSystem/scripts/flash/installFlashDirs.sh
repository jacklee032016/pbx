#/bin/sh
# 为Flash设备上的第三个分区，创建基本的目录结构和设备文件
# 李志杰 2006.12.03
#

cat << EOF
======================================================================
          Build FileSystem for FLASH Root File System from Scratch.
======================================================================
EOF
...
echo ""
echo "STEP 1 :"
echo "        Build Directories for FLASH" 
...
# while ( test -n "$1" ); do
	...
	users="root ftp lzj lizhijie dovecot"
	for u in $users; do
		mkdir -p $1/home/$u
...
cat << EOF
======================================================================
Device Files for Flash Root File System has been installed.
======================================================================
EOF
